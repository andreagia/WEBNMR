...
for line in open('listinput'):
	if int(line.split('_')[2]) not in k0710: 
		k0710.append(int(line.split('_')[2]))
#print k0710
k0710.sort()
...
for line in file2:
    ...
    i0710=k0710.index(int(ls2[0]))
    xx[i0710][v2.index('%0.3f' %float(ls2[1]))]=float(ls2[2])
